...
def index():
    ...
    # query = "SELECT * FROM Movie LIMIT 200"
    query = "SELECT *, Movie.movieid as movieid FROM Movie LEFT JOIN (SELECT * FROM Likes WHERE Likes.owner=?) as Temp1  ON Movie.movieid=Temp1.movieid LIMIT 200"
